...
function Statistics() {
    ...
    const exportToCSV = ()=>{
        ...
        a_0.href = url;
        a_0.download = `hawkwatch-statistics-${new Date().toISOString().split('T')[0]}.csv`;
        a_0.click();
        window.URL.revokeObjectURL(url);
    };
    // Prepare chart data
    const severityCounts = analyses.reduce((acc, a_1)=>{
        acc[a_1.severity] = (acc[a_1.severity] || 0) + 1;
        return acc;
    }, {});
    ...
    // Group by hour
    const hourlyData = analyses.reduce((acc_0, a_2)=>{
        const hour = new Date(a_2.timestamp).getHours();
        acc_0[hour] = (acc_0[hour] || 0) + 1;
        return acc_0;
    }, {});
    ...
    const pieData = severityData.map(({ severity: severity_0, count: count_0 })=>({
            name: severity_0,
            value: count_0,
            color: COLORS[severity_0]
        }));
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-3xl font-bold",
                                        children: [
                                            analyses.length > 0 ? Math.round(analyses.reduce((sum, a_3)=>sum + a_3.confidence, 0) / analyses.length) : 0,
                                            "%"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/statistics/page.tsx",
...
_s(Statistics, "aoY3a/kK3m6fK1X14H3rtdwvL3c=");
_c = Statistics;
var _c;
...
//# sourceMappingURL=src_0d7b9a74._.js.map